...
namespace OneManEscapePlan.UIList.Scripts {
	...
	/// <typeparam name="ItemView">A concrete implementation of UIListItemViewBase that will be used to render the data for a model</typeparam>
	...
	public abstract class AbstractUIListController<ItemModel, ItemView, ItemViewCollection> : MonoBehaviour 
		where ItemView : UIListItemViewBase<ItemModel>
		where ItemViewCollection : ICollection<ItemView>, new()
	{
		...
		[SerializeField] protected UIListItemViewBase<ItemModel>.UIListItemViewEvent clickedViewEvent = new UIListItemViewBase<ItemModel>.UIListItemViewEvent();
		internal UIListItemViewBase<ItemModel>.UIListItemViewEvent ClickedViewEvent => clickedViewEvent;
		...
		virtual protected void onItemClicked(UIListItemViewBase<ItemModel> view) {
